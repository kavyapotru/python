...
for i in range(len(t)):
    print(t[i], end=' ') # 5 4 3 2 1
print()
#Iterate from right to left
for i in range(len(t)-1, -1, -1):
    print(t[i], end=' ') # 1 2 3 4 5
print()
#set
#Iterate from left to right
s = [5, 4, 3, 2, 1]
...
for i in range(len(s)):
    print(s[i], end=' ') # 5 4 3 2 1
print()

# Iterate from right to left
for i in range(len(s)-1, -1, -1):
    print(s[i], end=' ') # 1 2 3 4 5
print()
#dictionary
...
print()
for x in d:
    print(d[x], end=' ') # e d c b a
print()
for x in d.values():   
    print(x, end=' ') # e d c b a
print()
for x in d.items():     
    print(x, end=' ') #(5, 'e') (4, 'd') (3, 'c') (2, 'b') (1, 'a')
print()
...
print('A') # assert N is not greater than 5
assert n < 5, 'N is not lesser than 5' 
print('B') # assert N is not greater than 5
